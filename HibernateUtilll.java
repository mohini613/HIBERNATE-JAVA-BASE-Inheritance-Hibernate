	...
	public class HibernateUtilll {
	    ...
	    public static SessionFactory getSessionFactory() {
	        if (sf == null) {
	            ...
	            settings.put(Environment.URL, "jdbc:mysql://localhost:3306/inheritance1");
	            ...
	            MetadataSources ms = new MetadataSources(registry)
	                    .addAnnotatedClass(com.InheritanceHibernate.Vehical.class)
	                    .addAnnotatedClass(com.InheritanceHibernate.Two_Wheeler.class)
	                    .addAnnotatedClass(com.InheritanceHibernate.Four_Wheeler.class);
;
